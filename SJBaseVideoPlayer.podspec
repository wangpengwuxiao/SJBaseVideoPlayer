Pod::Spec.new do |s|
  ...
  s.description  = 'https://github.com/wangpengwuxiao/SJBaseVideoPlayer/blob/master/README.md'
  s.homepage     = 'https://github.com/wangpengwuxiao/SJBaseVideoPlayer'
  s.license      = { :type => 'MIT', :file => 'LICENSE.md' }
  s.author       = { 'SanJiang' => 'changsanjiang@gmail.com' }
  s.platform     = :ios, '12.0'
  s.source       = { :git => 'https://github.com/wangpengwuxiao/SJBaseVideoPlayer.git', :tag => "v#{s.version}" }
